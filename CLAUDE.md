...
<!-- REPLACE THIS BLOCK: one-paragraph description of what ghostp13409-github-io is,
...
- **Docs:** <!-- e.g., docs/, agency/workstreams/ghostp13409-github-io/research/ -->
- **Workstreams:** `agency/workstreams/ghostp13409-github-io/` — shared project artifacts (PVR/A&D/Plan/KNOWLEDGE)
- **Principal sandbox:** `usr/parth/` — handoffs, dispatches, transcripts
...
Default agent classes available via `/agent-create` and Claude Code subagent auto-discovery (`.claude/agents/parth/`):
