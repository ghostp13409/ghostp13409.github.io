...
const Sidebar = ({ activeSection = "intro", onMenuItemClick, isMobile = false }: SidebarProps) => {
  ...
  const menuItems = [
    ...
    { id: "hire", label: "Say Hello", icon: <MessageCircle className="w-4 h-4" /> },
  ];
    ...
    <div className={cn(
      ...
      <div className="mb-16 relative group px-2">
        ...
        <div className="space-y-1">
          <h2 className="text-xl font-black text-text-main tracking-tight">Parth Gajjar</h2>
          <p className="text-[10px] font-black text-text-main/60 uppercase tracking-[0.2em] flex items-center gap-2">
            ...
            >
              <div className="flex items-center gap-4 relative z-10">
                <span className={cn(
                  ...
                  isActive ? "bg-accent-peach/10 text-accent-peach" : "bg-black/[0.02] dark:bg-white/5 text-text-muted group-hover:text-text-main"
                )}>
                  {item.icon}
                </span>
