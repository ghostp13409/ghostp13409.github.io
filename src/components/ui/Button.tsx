...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap text-[10px] font-mono font-black uppercase tracking-[0.2em] transition-all disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
