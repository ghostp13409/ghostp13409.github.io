        ...
        {[
          {
            ...
            desc: "I can build you a website that looks great and works even better!",
          },
          {
            title: "Software Engineering",
            desc: "I can build you a software that solves your problems",
          },
          {
            title: "Database Management",
            desc: "I can manage your database and make sure it's secure and efficient",
          },
          {
            title: "Testing & Quality Assurance",
            desc: "I can test your software and make sure no bug goes unnoticed!",
          },
        ].map((service, index) => (
          <motion.div
            key={index}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          ...
          <p className="text-gray-200 text-lg leading-relaxed">
            Java, Python, JavaScript, C#, React, ASP.Net, SQL, NoSQL You Name
            it, I got it...
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-200 text-lg leading-relaxed">
            Git, VS Code, JetBrains Suite, Docker, Slack <br />
            And I can master even more in just a few days of training!
          </p>
        </motion.div>
      </div>
    </section>
